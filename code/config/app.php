...
return [
    ...
    */
    ...
    'url' => env('APP_URL', 'http://api.xiv-local.world'),

    /*
    |--------------------------------------------------------------------------
    | Application Front-end Hostname
    |--------------------------------------------------------------------------
    |
    | The root hostname that the front-end runs on.
    |
    */

    'frontend_root_hostname' => env('APP_FRONTEND_ROOT_HOSTNAME', 'xiv-local.world:8080'),
